...
def accept_user_data():
    #sl = st.text_input("Enter the sepal length: e.g., 5.1")
    #sw = st.text_input("Enter the sepal width: e.g., 3.5")
    #pl = st.text_input("Enter the petal length: e.g., 1.4")
    #pw = st.text_input("Enter the petal width: e.g., 0.2")
